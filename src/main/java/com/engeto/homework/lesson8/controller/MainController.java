package com.engeto.homework.lesson8.controller;
...
public class MainController {
    ...
    public String romatic(){
        return "V bouřlivém městském ruchu se setkali dva cizinci. Jejich oči se setkaly a svět se zpomalil." +
    ...
    public String historic(){
        return "V době středověku se mezi dvěma královstvími rozpoutala zuřivá válka." +
                ...
                " Nakonec byli nuceni utéct, aby spolu mohli být. Jejich příběh zůstal jako legenda v dějinách," +
                " která připomíná sílu lásky v časech krutosti.";
    }
